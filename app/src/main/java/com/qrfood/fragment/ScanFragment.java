...
import com.qrfood.utility.qrcode.BarcodeGraphic;
import com.qrfood.utility.qrcode.BarcodeGraphicTracker;
import com.qrfood.utility.qrcode.BarcodeTrackerFactory;
import com.qrfood.utility.qrcode.CameraSource;
import com.qrfood.utility.qrcode.CameraSourcePreview;
import com.qrfood.utility.qrcode.GraphicOverlay;
                ...
                new BarcodeGraphicTracker.BarcodeAutoDetectionListener() {
                    ...
                    public void onNewBarcodeDetection(Barcode barcode) {
                        if (barcode != null) {
                            ...
                            commonMethods.setSharedPreferences(Constants.barcodeRawId, barcode.displayValue, Constants.aString);

                            FragmentTransaction transaction = getActivity().getSupportFragmentManager().beginTransaction();
                            transaction.replace(R.id.main_content_frame, new RestaurantFragment());
                            transaction.commit();
                        }
                    }
                });
